    ...
    describe(PublishMQCronjobSpek::class.java.simpleName) {
        with(TestApplicationEngine()) {
            ...
            val vedtakService = VedtakService(
                ...
                infotrygdService = InfotrygdService(externalMockEnvironment.pdlClient, mqSenderMock, testPersonMapping = externalMockEnvironment.environment.testPersonMapping,),
